        ...
        <div class="table-responsive" style="font-size: 18px;"> 
            <table class="table table-striped table-inverse">
             <thead class="thead-inverse">
                <tr><th>高峰</th><th>數值</th><th>高峰值</th></tr>
            </thead>
            <tbody>
              <tr><td>1</td><td><?php echo $numbers[0]?></td><td><?php echo $values[0]?></td></tr>
              <tr><td>2</td><td><?php echo $numbers[1]?></td><td><?php echo $values[1]?></td></tr>
              <tr><td>3</td><td><?php echo $numbers[2]?></td><td><?php echo $values[2]?></td></tr>
              <tr><td>4</td><td><?php echo $numbers[3]?></td><td><?php echo $values[3]?></td></tr>
              <tr><td>5</td><td><?php echo $numbers[4]?></td><td><?php echo $values[4]?></td></tr>
              <tr><td>6</td><td><?php echo $numbers[5]?></td><td><?php echo $values[5]?></td></tr>
              <tr><td>7</td><td><?php echo $numbers[6]?></td><td><?php echo $values[6]?></td></tr>
              <tr><td>8</td><td><?php echo $numbers[7]?></td><td><?php echo $values[7]?></td></tr>
              <tr><td>9</td><td><?php echo $numbers[8]?></td><td><?php echo $values[8]?></td></tr>
              <tr><td>10</td><td><?php echo $numbers[9]?></td><td><?php echo $values[9]?></td></tr>
              <tr><td>11</td><td><?php echo $numbers[10]?></td><td><?php echo $values[10]?></td></tr>
              <tr><td>12</td><td><?php echo $numbers[11]?></td><td><?php echo $values[11]?></td></tr>
          </tbody>
      </table>
  </div>
