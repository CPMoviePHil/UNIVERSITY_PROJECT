...
<body >
  ...
  <div class="content_size">
    ...
    <div id="index_word" class="index_content_css text-right">
      <label class="" id="pulser_css">Welcome to Pulser 2.0</label>
      <label class="" id="inspiring_css">Inspiring</label>
      <label class="" id="future">Future</label>
    </div>
